...
const Team = () => {
	return (
		<section
			id="team"
			className="py-12 md:py-20 px-4 bg-gradient-to-b from-white to-blue-50"
		>
							...
							<div className="relative rounded-2xl overflow-hidden shadow-2xl">
								...
								<div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-blue-900/90 to-transparent p-6 md:p-8">
									...
									<p className="text-blue-100 text-base md:text-lg">
										BDS, MIDA, General & Cosmetic Dentistry
									</p>
									<p className="text-blue-100 text-base md:text-lg">
										Certified Implantogist
									</p>
								</div>
							</div>
					...
					<div className="order-2 lg:order-2 px-4 lg:px-0">
						<div className="space-y-4 md:space-y-6">
							...
							<div>
								...
								<p className="text-l md:text-xl text-gray-600 leading-relaxed mb-3 md:mb-4">
									With over 12 years of experience, Dr. Ritee Agarwal is
									committed to providing personalized, comprehensive dental care
									in a comfortable and welcoming environment. Her gentle
									approach and attention to detail have helped countless
									patients achieve healthy, beautiful smiles.
								</p>
								<p className="text-sm md:text-base text-gray-600 leading-relaxed">
									Dr. Agarwal believes in educating patients about their oral
									health and working together to create customized treatment
									plans that meet individual needs and goals.
								</p>
							</div>
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4 pt-2">
								...
								<div className="bg-white rounded-xl p-4 md:p-5 shadow-md border border-gray-100">
									<div className="flex items-start gap-3">
										...
										<div>
											<h4 className="font-semibold text-gray-800 text-l md:text-xl mb-1">
												Experience
											</h4>
