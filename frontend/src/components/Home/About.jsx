        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 md:pl-12">
            ...
            <p className="text-gray-600 mb-4">
              At BrightSmile Dental, we've been serving our community for over 15 years with compassionate, personalized dental care. Our modern facility is equipped with the latest technology to ensure effective and comfortable treatments.
            </p>
            <p className="text-gray-600 mb-6">
              Our mission is to provide exceptional dental care in a comfortable and welcoming environment. We believe in educating our patients about their oral health and working together to achieve lasting results.
            </p>
